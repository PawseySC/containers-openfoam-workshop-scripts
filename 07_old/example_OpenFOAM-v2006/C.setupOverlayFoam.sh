...
#5. Rename the processor* directories into bak.processor*
...
#9. Transfer the content of the bak.processor* directories into the overlayFS
...
copyIntoOverlayII $overlayFSDir 'bak.processor${ii}/*' "$insideDir/"'processor${ii}/' "$foam_numberOfSubdomains" "true";success=$? 
