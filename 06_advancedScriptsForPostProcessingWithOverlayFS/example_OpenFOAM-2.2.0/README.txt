...
(And the optional:)
zeus-1:example_OpenFOAM-2.2.0> sbatch -p debugq ../example_OpenFOAM-2.4.0/F.extractFromOverlayIntoBak.sh
zeus-1:example_OpenFOAM-2.2.0> sbatch -p debugq ../example_OpenFOAM-2.4.0/G.reconstructFromBak.sh
